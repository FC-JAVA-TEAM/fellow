...
public class NamazView extends Div implements RouterLayout {
    ...
    private void init() {
        ...
        Label titleLabel = new Label("Namaz Tracker");
        ...
        // Add a new column for progress bar (only for parent rows)
      //  treeGrid.addComponentColumn(this::createParentProgressBar).setHeader("Progress");
     // Add a new column for progress bar (parent and child-specific)
